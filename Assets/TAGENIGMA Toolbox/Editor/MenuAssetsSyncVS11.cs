...
public class MenuAssetsSyncVS11 : MenuAssetsSyncVSCommon
{
    ...
    private const string FILE_SLN_11_SUFFIX = "-VS11.sln";
    private const string FILE_CSPROJ_11_SUFFIX = "-VS11.csproj";
    private const string FILE_SUO_11_SUFFIX = "-VS11.suo";
    private const string FILE_CSPROJ_USER_11_SUFFIX = "-VS11.csproj.user";
