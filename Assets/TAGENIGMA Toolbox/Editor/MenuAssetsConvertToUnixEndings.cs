...
public class MenuAssetsConvertToUnixEndings : MonoBehaviour
{
    [MenuItem("Assets/Convert to Unix Line Endings")]
    ...
    /// </summary>
    /// <returns></returns>
    [MenuItem("Assets/Convert to Unix Line Endings", validate = true)]
    public static bool CheckConvertLineEndings()
    {
        return ToolboxEditor.GetLineMode() == ToolboxEditor.LineModes.Unix;
    }
